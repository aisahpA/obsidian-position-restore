export const en = {
	...
	'dataStorage.dbFileName.confirm': 'Confirm and validate',
	...
	'dataStorage.dbFileName.messages.noFolder': 'The folder does not exist. Create it in the vault first.',
